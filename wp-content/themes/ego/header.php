	...
	<?php } ?>
		<div class="inner">
			<div class="logo-container">
				<div class="logo">
					<a class="navigateTo" href="<?php echo home_url(); ?>" title="<?php bloginfo( 'name' ); ?>"><img src="http://mariosarti.com.au/wp-content/uploads/udf_foundry/images/logo.png" alt="<?php bloginfo( 'name' ); ?>" /></a>
				</div>
			</div>            
