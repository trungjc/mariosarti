...
function create_portfolio_post_type() {
	register_post_type( 'udt_portfolio',
		array(
			'labels' => array(
				'name' => __( 'gallery', 'ego' ),
				'singular_name' => __( 'gallery', 'ego' ),
				'all_items' => __( 'All gallery', 'ego' ),
				'add_new_item' => __( 'Add New gallery', 'ego' ),
				'edit_item' => __( 'Edit gallery', 'ego' ),
				'new_item' => __( 'New gallery', 'ego' ),
				'view_item' => __( 'View gallery', 'ego' ),
				'search_items' => __( 'Search gallery', 'ego' ),
				'not_found' => __( 'No gallery found', 'ego' ),
				'not_found_in_trash' => __( 'No gallery found in Trash', 'ego' ),
			),
...
function sc_tabs( $atts, $content = null ) {
	...
	$content = do_shortcode( shortcode_unautop( $content ) );
	$content = preg_replace('#^<\/p>|<p>$#', '', $content);
	$output='<div class="tabs s" style="'.$style.'">';
...
// Create post type for function
add_action( 'init', 'post_type_function' );
if( ! function_exists( 'post_type_function' ) ) {
	function post_type_function() {
		register_post_type( 'function', array(
			'labels' => array(
				'name' => __( 'Functions', 'Function' ),
				'singular_name' => __( 'Function', 'Function' ),
				'add_new' => __( 'Add a Function', 'Function' ),
				'add_new_item' => __( 'Add New Function', 'Function' ),
				'edit_item' => __( 'Edit Function', 'Function' ),
				'new_item' => __( 'New Function', 'Function' ),
				'view_item' => __( 'View Function', 'Function' ),
				'search_items' => __( 'Find a Function', 'Function' ),
				'not_found' =>	__( 'No Function found', 'Function' ),
				'parent_item_colon' => '',
				'menu_name' => __( 'Functions', 'Function' )
			),
			'public' => true,
			'publicly_queryable' => true,
			'query_var' => true,
			...
			'has_archive' => false,
			'hierarchical' => true,
			'supports' => array( 'title', 'editor', 'thumbnail', 'author', 'page-attributes', 'comments','excerpt' ),
...
// Create post type for new
add_action( 'init', 'post_type_new' );
if( ! function_exists( 'post_type_new' ) ) {
	function post_type_new() {
		register_post_type( 'new', array(
			'labels' => array(
				'name' => __( 'News', 'New' ),
				'singular_name' => __( 'New', 'New' ),
				'add_new' => __( 'Add a New', 'New' ),
				'add_new_item' => __( 'Add New New', 'New' ),
				'edit_item' => __( 'Edit New', 'New' ),
				'new_item' => __( 'New New', 'New' ),
				'view_item' => __( 'View New', 'New' ),
				'search_items' => __( 'Find a New', 'New' ),
				'not_found' =>	__( 'No New found', 'New' ),
				'parent_item_colon' => '',
				'menu_name' => __( 'News', 'New' )
			),
			'public' => true,
			'publicly_queryable' => true,
			'query_var' => true,
