...
function wprmm_load_admin_page(){
  $admin_page = $_GET[WPRMM_ADMIN_PARSE];
  switch($admin_page){
    ##  Menus ##
    case '':
...
function wprmm_load_admin_icon_page(){
  $admin_icon_page = $_GET[WPRMM_ADMIN_ICON_PARSE];
...
function wprmm_save_menu(){
  if($_POST['save_menu'] != 'Save Menu') return '';
  $menu = $_POST['wprmm'];
...
function wprmm_save_category(){
  if($_POST['save_category'] != 'Save Category') return '';
...
function wprmm_save_item(){
  if($_POST['save_item'] != 'Save Item') return '';
  $item = $_POST['wprmm'];
...
function wprmm_save_icon(){
  if($_POST['save_item'] != 'Save Icon') return '';
  $icon = $_POST['wprmm'];
...
function wprmm_save_global_settings(){
  if($_POST['save_options'] != 'Save Options') return '';
  $options = $_POST['wprmm'];
