...
<div class="wrap wprmm">
  ...
  <form method="POST" action="<?php echo WPRMM_CRUD; ?>">
    ...
    <input type="hidden" name="wprmm[menu_id]" value="<?php echo $menu->id;?>" />
    <input type="hidden" name="wprmm_crud[item]" value="new" /> 

    <div class="wprmm-admin-nav">
      <p>
        <input class="button-primary" class="left" type="submit" name="save_item" value="Save Item" />
        <a class="button" href="<?php echo wprmm_admin_url('menu','index-item',$menu->id);?>">&laquo;back</a>&nbsp;
